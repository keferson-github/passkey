...
export const setupAvatarStorage = async () => {
  try {
    ...
    console.log('Nota: As políticas devem ser configuradas manualmente no console do Supabase ou via SQL.');
    console.log('Execute o script SQL de migração para configurar as políticas corretamente.');
...
export const testAdminUpload = async () => {
  try {
    ...
    const fileName = `test_admin_${Date.now()}.png`;
